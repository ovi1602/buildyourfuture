...
<div>
		...
		<br />
		<br />
		Don't have an account? Click the button below to register! <br />
		<input type="submit" value="Register" style="height:50px;width:150px;cursor:pointer;" onclick="location.href='register.php'">
