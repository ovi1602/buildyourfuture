...
$sal=1;
mysql_query("UPDATE profesor SET vot3='$codnou' WHERE account='$_COOKIE[logat]'");
mysql_query("UPDATE profesor SET votat3='$sal' WHERE account='$_COOKIE[logat]'");
echo 'Voting succeded.';
echo '<meta HTTP-EQUIV="REFRESH" content="1; url=evaluareother.php">';
?>
